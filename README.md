...
이 문서는 2026-07 리뉴얼(전역 메뉴바 추가, SEO 개편, `play.html` 성능 개선) 및
**2026-07 UI/UX 리디자인**(토스·당근 스타일의 간결함 + 육아 서비스만의 따뜻함, 세이지 그린/샌드
옐로우 디자인 시스템, 하단 탭바, 한 손 조작형 입력 UI 등) 내용을 포함해 프로젝트 전체 구조와
운영 방법을 정리한 것입니다.

> **이번 리디자인 작업 상세 내용은 바로 아래 [0. UI/UX 리디자인 업데이트](#0-uiux-리디자인-업데이트-2026-07) 섹션을 참고하세요.**
> 그 이하(1번부터)는 이전 리뉴얼(메뉴바/SEO/성능/개인화 시스템) 문서로, 기능 자체는 이번 작업에서
> 그대로 유지되었습니다.

---

## 0. UI/UX 리디자인 업데이트 (2026-07)
